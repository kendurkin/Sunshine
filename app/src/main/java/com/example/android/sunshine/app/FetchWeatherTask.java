...
public class FetchWeatherTask extends AsyncTask<String,Void,Void> {
    ...
    private long addLocation(String locationSetting, String cityName, double lat, double lon){
        ...
        //Check if location exists in the db
    ...
    protected Void doInBackground(String... params) {
        ...
        //If no zip code, no need to look up. Verify param size.
        if (params.length == 0)
            return null;
        ...
        //This will only happen if there was an error getting/parsing forecast
        return null;
    }
}